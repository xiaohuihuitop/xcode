...
func (s *GatewayService) Forward(ctx context.Context, c *gin.Context, account *Account, parsed *ParsedRequest) (*ForwardResult, error) {
	...
	if account != nil && s.shouldEmulateWebSearch(ctx, account, parsed.PlatformID, parsed.Body.Bytes()) {
...
func (s *GatewayService) ResolvePlatformModelMapping(ctx context.Context, model string) ModelMappingResult {
