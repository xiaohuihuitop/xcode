...
func TestEveryGatewayPOSTRouteIsClassifiedForPromptAuditCoverage(t *testing.T) {
	...
	audited := map[string][]string{
		"/messages":                 {"gateway_handler.go", "openai_gateway_handler.go", "runtime_ingress_preflight.go"},
		"/responses":                {"gateway_handler_responses.go", "openai_gateway_handler.go", "runtime_ingress_preflight.go"},
		"/responses/*subpath":       {"gateway_handler_responses.go", "openai_gateway_handler.go", "runtime_ingress_preflight.go"},
		"/chat/completions":         {"gateway_handler_chat_completions.go", "runtime_ingress_preflight.go"},
		"/embeddings":               {"runtime_ingress_preflight.go"},
		"/alpha/search":             {"runtime_ingress_preflight.go"},
		"/live":                     {"openai_live.go"},
		"/realtime/calls":           {"openai_live.go"},
		"/images/generations":       {"runtime_ingress_preflight.go", "grok_media.go"},
		"/images/edits":             {"runtime_ingress_preflight.go", "grok_media.go"},
