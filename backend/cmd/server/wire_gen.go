...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingService := service.ProvideSettingService(settingRepository, proxyRepository, paymentConfigService, configConfig)
	...
	apiKeyService := service.ProvideAPIKeyService(apiKeyRepository, userRepository, userSubscriptionRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, paymentConfigService, platformService)
	apiKeyAuthCacheInvalidator := service.ProvideAPIKeyAuthCacheInvalidator(apiKeyService)
	promoService := service.NewPromoService(promoCodeRepository, userRepository, billingCacheService, client, apiKeyAuthCacheInvalidator)
	subscriptionService := service.NewSubscriptionService(userSubscriptionRepository, billingCacheService, client, configConfig)
	...
	defaultAPIKeyProvisioner := service.ProvideDefaultAPIKeyProvisioner(apiKeyService)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, defaultAPIKeyProvisioner)
	...
	schedulerSnapshotService := service.ProvideSchedulerSnapshotService(schedulerCache, schedulerOutboxRepository, accountRepository, platformRepository, configConfig)
	...
	modelPricingOverrideRepository := repository.NewModelPricingOverrideRepository(db)
	modelPricingCatalog := service.NewModelPricingCatalog(modelPricingOverrideRepository)
	modelPricingResolver := service.NewModelPricingResolverWithCatalog(billingService, modelPricingCatalog)
	...
	gatewayService := service.NewGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository)
	...
	geminiMessagesCompatService := service.NewGeminiMessagesCompatService(accountRepository, gatewayCache, schedulerSnapshotService, geminiTokenProvider, rateLimitService, httpUpstream, antigravityGatewayService, configConfig)
	...
	platformCatalogService := service.ProvidePlatformCatalogService(platformService, modelPricingResolver)
	modelPricingHandler := handler.ProvideAdminModelPricingHandler(modelPricingCatalog, platformCatalogService, platformService)
	...
	glmQuotaService := service.ProvideGLMQuotaService(accountRepository, platformRepository, httpUpstream, configConfig)
	glmQuotaHandler := admin.NewGLMQuotaHandler(glmQuotaService)
	...
	contentModerationService := service.NewContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, platformRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, platformHandler, modelPricingHandler, accountHandler, glmQuotaHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, scheduledTestHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	availablePlatformHandler := handler.NewAvailablePlatformHandler(platformCatalogService)
	modelPlazaHandler := handler.ProvideModelPlazaHandler(platformCatalogService, settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availablePlatformHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, platformService, redisClient)
