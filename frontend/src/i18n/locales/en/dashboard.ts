export default {
  ...
  keys: {
    ...
    billingLabel: 'Billing Assets',
    billingHint: 'The subscription switch covers current and future purchases.',
    allowAllSubscriptionsLabel: 'Allow Subscriptions',
    allowAllSubscriptionsHint: 'Enable to use all current and future subscription plans automatically.',
    allSubscriptionsEnabled: 'All subscriptions',
    selectedSubscriptions: 'Authorized subscriptions ({count})',
    ...
    billingSourceRequired: 'Enable subscriptions or balance charging',
    statusLabel: 'Status',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      officialPrice: 'Official public price (reference cost)',
      salePrice: 'Platform price',
      inheritedPrice: 'Inherited official price',
      customPrice: 'Custom price',
      noPrice: 'No price available',
      balanceRate: 'Rate',
      unitPerMillion: 'USD/1M Token',
