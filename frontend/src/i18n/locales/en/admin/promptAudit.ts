export default {
  promptAudit: {
    ...
    policy: {
      title: 'Audit policy', description: 'Configure platform scope, nine input-risk categories, workers, and queue bounds.', scope: 'Scope', allPlatforms: 'All platforms', selectedPlatforms: 'Selected platforms',
      searchPlatforms: 'Search platforms', noPlatforms: 'No matching platforms', missingPlatforms: 'Configured IDs for platforms that no longer exist', selectedPlatformCount: '{count} platforms selected',
    ...
    events: {
      groupId: 'Legacy group ID', group: 'Legacy group',
      title: 'Audit events', description: 'Review events by identity, route, risk, hash, and time; the detail view shows the full prompt.', decision: 'Decision', risk: 'Risk level', endpoint: 'Endpoint', platformId: 'Platform ID', userId: 'User ID', apiKeyId: 'API Key ID', keyword: 'Keyword',
      ...
      moreConditions: 'More conditions (endpoint / keyword / platform / user)',
      ...
      selectAll: 'Select all events on this page', selectEvent: 'Select event {id}', time: 'Time', identity: 'User / email / API Key', user: 'Username', email: 'User email', apiKey: 'API Key name', platform: 'Platform', route: 'Endpoint / model', result: 'Decision / risk', preview: 'Redacted preview', empty: 'No matching events.',
    ...
    errors: {
      loadGroups: 'Legacy groups are no longer available.', prompt_audit_groups_required: 'Legacy group scope is no longer supported.',
      loadConfig: 'Unable to load Prompt Audit configuration.', loadRuntime: 'Unable to load Prompt Audit runtime.', loadPlatforms: 'Unable to load platforms.', loadEvents: 'Unable to load audit events.', loadDetail: 'Unable to load event details.', saveConfig: 'Unable to save the configuration.', probe: 'Node probe failed.', delete: 'Unable to delete events.', previewDelete: 'Unable to create a deletion preview. Check the time range.', deleteConfirmation: 'The deletion confirmation is invalid or expired. Preview again.',
      ...
      prompt_guard_requires_audit_enabled: 'Enable Prompt Audit before synchronous blocking.', prompt_audit_invalid_endpoint: 'The audit node configuration is invalid.', prompt_audit_endpoint_required: 'Enable at least one audit node before enabling Prompt Audit.', prompt_audit_platforms_required: 'Select at least one platform in selected-platform mode.', prompt_audit_scanners_required: 'Enable at least one risk category.',
    },
  },
}
