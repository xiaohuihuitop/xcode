export default {
  batchImage: {
    ...
    create: {
      ...
      noKeysHint: 'No Gemini API key is available for batch image generation. Create one and authorize a Gemini platform that exposes batch image models.',
      model: 'Model',
    ...
    guide: {
      ...
      step1: '1. Select an API key authorized for a Gemini platform. The model list shows models available on that platform.',
    ...
    messages: {
      ...
      noModelsHint: 'The Gemini platform authorized for this key has no batch image models configured.',
      noCompatibleAccount: 'No usable upstream batch image account is available in the Gemini platform pool. Contact an administrator to check its accounts and model support.',
