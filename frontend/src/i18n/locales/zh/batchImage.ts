export default {
  batchImage: {
    ...
    create: {
      ...
      noKeysHint: '当前没有可用于批量生图的 Gemini API Key。请先创建并授权包含批量生图模型的 Gemini 平台。',
      model: '模型',
      imageSize: '图片尺寸',
    ...
    guide: {
      title: '批量生图使用说明',
      uiTitle: '当前界面如何使用',
      step1: '1. 选择已授权 Gemini 平台的 API Key，模型列表会按平台可用模型展示。',
    ...
    messages: {
      ...
      noModels: '无可用模型',
      noModelsHint: '当前密钥授权的 Gemini 平台没有配置可用于批量生图的模型。',
      noCompatibleAccount: '当前 Gemini 平台没有可用的批量生图上游账号。请联系管理员检查平台账号池和模型支持。',
