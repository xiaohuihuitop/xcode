export default {
  ...
  keys: {
    ...
    billingLabel: '扣费资产',
    billingHint: '套餐开关允许使用当前及未来购买的所有套餐。',
    allowAllSubscriptionsLabel: '允许使用套餐',
    allowAllSubscriptionsHint: '开启后自动包含当前和以后购买的所有套餐。',
    allSubscriptionsEnabled: '全部套餐',
    selectedSubscriptions: '已授权套餐（{count}）',
    balanceLabel: '允许使用余额',
    balanceHint: '套餐不可用或已耗尽时，允许按全局余额倍率使用余额扣费。',
    balanceEnabled: '余额',
    noBillingSource: '未授权扣费资产',
    platformRequired: '请至少选择一个平台',
    billingSourceRequired: '请至少开启套餐或余额扣费',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      imageOutput: '图片输出',
      balancePrice: '参考价格',
      officialPrice: '官方公开价（参考成本）',
      salePrice: '平台售价',
      inheritedPrice: '继承官方价',
      customPrice: '自定义售价',
      noPrice: '暂无价格',
      balanceRate: '倍率',
