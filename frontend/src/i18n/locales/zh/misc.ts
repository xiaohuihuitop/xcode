export default {
  ...
  payment: {
    ...
    customAmountPrefix: '自定义',
    customAmountHighlight: '支付',
    customAmountSuffix: '金额',
    minimumRechargeAmount: '最小充值额度',
    maximumRechargeAmount: '最大充值额度',
    noLimit: '不限制',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    fee: '手续费',
    ...
    rechargeCreditPreview: '充值 {amount} → 到账 {credited}',
    refundReason: '退款原因',
    ...
    subscribeNow: '立即开通',
    addAnother: '再来一个',
    independentSubscriptionNotice: '每次购买都会创建一份独立订阅，不会累计时长；多份订阅会叠加使用，并按系统顺序扣费。',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      rate: '倍率',
