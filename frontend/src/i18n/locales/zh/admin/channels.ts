export default {
    riskControl: {
      ...
      queueDelay: '排队 {ms} ms',
      allPlatforms: '全部平台',
      allPlatformsHint: '当前审计全部平台',
      selectedPlatformsHint: '当前审计指定平台',
      platformScope: '审计平台',
      platformScopeHint: '开启右侧开关表示全部平台，关闭后选择指定平台。',
      selectedPlatforms: '指定平台',
      searchPlatforms: '搜索平台名称或适配器',
      noPlatforms: '暂无可用平台',
      modelFilter: '模型范围',
    ...
    subscriptions: {
      ...
      guide: {
        ...
        tip: '提示：这里只显示已启用的订阅套餐。如果没有可选项，请先到订阅套餐页面创建并启用套餐。'
      }
    },
