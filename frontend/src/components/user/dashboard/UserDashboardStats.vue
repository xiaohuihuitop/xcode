<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <router-link
      v-if="!isSimple"
      to="/purchase"
      class="card block p-4 transition-colors hover:border-primary-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-900"
    >
  ...
  <div v-if="displayedSubscriptions.length > 0" class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    <router-link
      ...
      :key="subscription.id"
      to="/subscriptions"
      class="block rounded-lg transition-colors hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-900"
    >
      <UserSubscriptionSummaryCard :subscription="subscription" />
    </router-link>
  </div>
